...
```sh
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/watt-mind/openSzigno/releases/download/v0.7.1/openszigno-cli-installer.sh | sh
```

```powershell
powershell -ExecutionPolicy Bypass -c "irm https://github.com/watt-mind/openSzigno/releases/download/v0.7.1/openszigno-cli-installer.ps1 | iex"
```
...
```sh
docker run --rm -v "$PWD:/work" ghcr.io/watt-mind/openszigno:0.7.1 inspect /work/file.es3 --json
```
