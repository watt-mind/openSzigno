...
| `openszigno-core`, `openszigno-verify`, `openszigno-author`, `openszigno-cli` crates | `release.yml` calling `publish-crates.yml` | crates.io |
...
`openszigno-core` published but `openszigno-verify` failed retries from
...
- The `openszigno-core`, `openszigno-verify`, `openszigno-author`, and
