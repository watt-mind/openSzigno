...
| ETSI TS 119 612: Trusted Lists | V2.4.1, 2025-08 | <https://www.etsi.org/deliver/etsi_ts/119600_119699/119612/02.04.01_60/ts_119612v020401p.pdf> | `refs/xades/ts_119612v020401p_TrustedLists.pdf` | `83285a1069e369d225cf16a0051a46b1f9d8961b6ad5d66bb7650351309a5196` | Same ETSI terms | Defines the LOTL/national-trusted-list XML schema and the qualification-status derivation rules used by `docs/verify-design.md` section 4. The TLv6 facts in [docs/trust.md](trust.md#tlv5-and-tlv6) come from it: clause 5.3.1 `TSLVersionIdentifier` "shall be `6`"; annex B.0 keeps the namespace `http://uri.etsi.org/02231/v2#`; clause 5.7.1 requires XAdES-B-B per EN 319 132-1 and restricts the scheme operator's own certificate: the issuer "shall be the TLSO itself (i.e. a self-signed certificate) or a TSP trust service listed in the TL or in one of the TL that is part of the same community", the KeyUsage "shall be set to digitalSignature and/or to nonRepudiation (contentCommitment) to the exclusion of any other KeyUsage value", the ExtendedKeyUsage "should be present containing id-tsl-kp-tslSigning" (`0.4.0.2231.3.0`, a should and not a shall), and BasicConstraints "shall indicate CA=false"; annex B.1.1 makes `xades:SigningCertificateV2` "an effective way of securing the scheme operator identifier"; annex B.1.0 fixes the enveloped signature, the exclusive canonicalization and the reference to `TrustServiceStatusList`; annex B.1.2 allows XML-Signature's algorithms plus ECDSA and SHA-2, bounded by ETSI TS 119 312 tables 4, 6 and 7; annex D.5.6 lists the service statuses, unchanged from TLv5. |
